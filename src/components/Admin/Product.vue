<template>
  <section class="section container">
    ...
    <a @click="addingProduct = true" class="button is-primary"><fa-icon icon="user-secret" /> Add product</a>
    ...
    <div class="box" v-for="(product, index) in products" :key="product.id">
      <h2 class="title is-5">{{ product.data.name }}
        <span class="is-pulled-right">
          <a @click="editProduct(index)" class="button is-primary"><fa-icon icon="edit" />Edit</a>
          <a @click="deleteProduct(index)" class="button is-danger"><fa-icon icon="times" />Delete</a>
        </span>
      </h2>
        ...
        <table class="table is-narrow">
          ...
          <tbody>
            <tr v-for="(size, sizeIndex) in product.data.sizes" :key="sizeIndex">
              ...
              <td><a @click="deleteSize(index, sizeIndex)" class="button is-danger"><fa-icon icon="times" />Delete</a></td>
            </tr>
            ...
            <tr>
              ...
              <td><button type="submit" class="button is-success"><fa-icon icon="plus" />Add</button></td>
            </tr>
          </tbody>
        </table>
      </form>
